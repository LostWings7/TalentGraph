...
SECRET_KEY = os.getenv('SECRET_KEY', 'talentgraph-ai-hackathon-insecure-secret-key-2026')
...
INSTALLED_APPS = [
    ...
    'apps.mobility.apps.MobilityConfig',
...
WSGI_APPLICATION = 'talentgraph.wsgi.application'

# Database
# Using SQLite for hackathon prototype
DATABASES = {
    'default': {
